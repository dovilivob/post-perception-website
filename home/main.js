...
const test = await fbxLoader.loadAsync('/static/fbx/test.fbx');
const test2 = await fbxLoader.loadAsync('/static/fbx/test2.fbx');
const test3 = await fbxLoader.loadAsync('/static/fbx/test3.fbx');
const test4 = await fbxLoader.loadAsync('/static/fbx/test4.fbx');
const test5 = await fbxLoader.loadAsync('/static/fbx/test5.fbx');
const test6 = await fbxLoader.loadAsync('/static/fbx/test6.fbx');
const test7 = await fbxLoader.loadAsync('/static/fbx/test7.fbx');
const test8 = await fbxLoader.loadAsync('/static/fbx/test8.fbx');
const room = await fbxLoader.loadAsync('/static/fbx/room.fbx');
const try1 = await fbxLoader.loadAsync('/static/fbx/try.fbx');
objects[0] = test;
objects[1] = test2;
objects[2] = test3;
objects[3] = test4;
